...
| 2026-07-23 | CK | Quarantena e validazione prospettica | Implementazione completa: OBSERVE default, latency-arb off, HARVEST/arb off, COPY journal-only; ask/bid VWAP, dedup evento, circuit breaker persistenti, run archive e dashboard safety. 17 unittest + browser smoke snapshot OK. | Deploy VPS ancora da eseguire con `./start_all.sh restart` senza reset; poi 24h zero aperture e 48h journal. |
